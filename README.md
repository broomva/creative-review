# creative-review (DEPRECATED — migrated to broomva/skills monorepo)
...
```bash
npx skills add broomva/skills --skill creative-review
```

## Skill home (new)

[broomva/skills/skills/creative-review](https://github.com/broomva/skills/tree/main/skills/creative-review)
